...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and submit the login form (click 'Ingresar').
        ...
        # -> Click the 'Revisar leads' alert action to inspect its context and navigate to the related leads view, then wait for the page to load.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div[2]/main/div/div/div[5]/div/a').nth(0)
        await asyncio.sleep(3); await elem.click()
